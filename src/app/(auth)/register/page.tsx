...
import { Scale, Lock, Mail, User, Building2, ArrowRight } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    await register(name || 'Legal Analyst', email, password);
    setIsLoading(false);
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-slate-100 relative overflow-hidden">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-extrabold tracking-tight">Create LEGALOS Account</h1>
          <p className="text-xs text-slate-400">Join Acme Global Legal Operations Hub</p>
        </div>
