    ...
    <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-[#FAF9F5] dark:bg-[#15161D] border border-[#E2DFD6] dark:border-[#2B2D3C] rounded-xl text-xs font-semibold text-[#18181B] dark:text-slate-100 focus:outline-none"
                />
              </div>
      ...
      {activeTab === 'notifications' && (
        <Card className="max-w-2xl space-y-4 p-6">
          ...
          <div className="divide-y divide-[#E6E4DF] dark:divide-[#252732]">
            {[
      ...
      {activeTab === 'billing' && (
        <Card className="max-w-2xl space-y-6 p-6">
          <div className="flex items-center justify-between p-4 rounded-2xl bg-[#EFECE6] dark:bg-[#1F212B] border border-[#E2DFD6] dark:border-[#2A2D3C]">
            <div>
          ...
          <div className="space-y-2">
            ...
            <div className="h-3 w-full bg-[#FAF9F5] dark:bg-[#14151B] border border-[#E6E4DF] dark:border-[#252732] rounded-full overflow-hidden">
      ...
      {activeTab === 'security' && (
        <Card className="max-w-2xl space-y-4 p-6">
          ...
          <div className="p-4 rounded-2xl bg-[#FAF9F5] dark:bg-[#15161D] border border-[#E6E4DF] dark:border-[#252732] flex items-center justify-between">
        ...
        <Card className="max-w-2xl space-y-4 p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className={`p-5 rounded-2xl border text-left flex flex-col justify-between h-32 transition-all ${
                theme === 'light'
                  ...
                  : 'border-[#E6E4DF] dark:border-[#252732]'
              }`}
            >
            ...
            <button
              ...
              className={`p-5 rounded-2xl border text-left flex flex-col justify-between h-32 transition-all ${
                theme === 'dark'
                  ? 'border-white bg-[#0E0F13] text-white shadow-2xs'
                  : 'border-[#E6E4DF] dark:border-[#252732]'
              }`}
            >
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-400 font-medium">Deep charcoal dark mode (#0E0F13)</p>
              </div>
            </button>
          </div>
        </Card>
